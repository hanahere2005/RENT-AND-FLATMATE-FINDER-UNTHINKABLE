...
from backend.controllers.owner_controller import (
    get_owner_listings, get_owner_requests, accept_request, reject_request, update_request_status, delete_listing
)

owner_bp = Blueprint('owner', __name__)

owner_bp.route('/listings', methods=['GET'])(get_owner_listings)
owner_bp.route('/listings/<int:listing_id>', methods=['DELETE'])(delete_listing)
